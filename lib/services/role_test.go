...
func TestCheckAccessToDatabase(t *testing.T) {
	utils.InitLoggerForTests(testing.Verbose())
	dbStage := types.NewDatabaseServerV2("stage",
		map[string]string{"env": "stage"},
		DatabaseServerSpecV2{})
	dbProd := types.NewDatabaseServerV2("prod",
...
func TestCheckAccessToDatabaseService(t *testing.T) {
	utils.InitLoggerForTests(testing.Verbose())
	dbNoLabels := types.NewDatabaseServerV2("test",
		nil,
		DatabaseServerSpecV2{})
	dbStage := types.NewDatabaseServerV2("stage",
		map[string]string{"env": "stage"},
	...
	dbStage2 := types.NewDatabaseServerV2("stage2",
		map[string]string{"env": "stage"},
		DatabaseServerSpecV2{

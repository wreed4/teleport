...
type Resource interface {
	...
	SetTTL(clock TTLClock, ttl time.Duration)
...
// TTLClock is used to track TTL of resources
...
// SetTTL sets Expires header using current clock
func (h *ResourceHeader) SetTTL(clock TTLClock, ttl time.Duration) {
...
func (m *Metadata) SetTTL(clock TTLClock, ttl time.Duration) {
